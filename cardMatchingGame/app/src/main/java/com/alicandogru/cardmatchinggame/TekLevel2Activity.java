...
public class TekLevel2Activity extends AppCompatActivity {
    long kalansure;
    ...
    String [] evler = {"Gryffindor","Slytherin","Hufflepuff","Ravenclaw"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tek_level2);
        switchSes = findViewById(R.id.switchTek2);

        oyunMuzik = MediaPlayer.create(TekLevel2Activity.this,R.raw.oyunmuzik);
        dogruMuzik = MediaPlayer.create(TekLevel2Activity.this,R.raw.dogrumuzik);
        oyunBitti = MediaPlayer.create(TekLevel2Activity.this,R.raw.oyunbitti);
        sureBitti = MediaPlayer.create(TekLevel2Activity.this,R.raw.surebittimuzik);
        ...
        if (tik11 && tik13) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    etki = ((((puan11 + puan33) / 2) * 4) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik11 && tik14) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //yanlış eşleştirmede kartların farklı evlerden olma durumu
                    //iki evin katsayısının 2 2 olma durumu
                    etki = ((((puan11 + puan44) / 2) * 4) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik11 && tik15) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    etki = ((((puan11 + puan55) / 2) * 2) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik11 && tik16) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    etki = ((((puan11 + puan66) / 2) * 2) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik11 && tik17) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //yanlış eşleştirmede kartların farklı evlerden olma durumu
                    //birinci evin 1 ikinci evin 2 katsayılı olma durumu
                    etki = ((((puan11 + puan77) / 2) * 2) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik11 && tik18) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //kartlar yanlış evleri kontrol edip puan hesaplaması yapılabilir.
                    //birinci evin 1 ikinci evin 2 katsayılı olma durumu
                    etki = ((((puan11 + puan88) / 2) * 2) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                    }
            }, 800);
        ...
        if (tik12 && tik13) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //yanlış eşleştirmede kartların farklı evlerden olma durumu
                    //iki evin katsayısının 2 2 olma durumu
                    etki = ((((puan33 + puan22) / 2) * 4) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik12 && tik14) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //yanlış eşleştirmede kartların farklı evlerden olma durumu
                    //iki evin katsayısının 2 2 olma durumu
                    etki = ((((puan44 + puan22) / 2) * 4) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik12 && tik15) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //yanlış eşleştirmede kartların farklı evlerden olma durumu
                    //birinci evin 2 ikinci evin 1 katsayılı olma durumu
                    etki = ((((puan55 + puan22) / 2) * 2) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik12 && tik16) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //yanlış eşleştirmede kartların farklı evlerden olma durumu
                    //birinci evin 1 ikinci evin 2 katsayılı olma durumu
                    etki = ((((puan66 + puan22) / 2) * 2) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik12 && tik17) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //yanlış eşleştirmede kartların farklı evlerden olma durumu
                    //birinci evin 1 ikinci evin 2 katsayılı olma durumu
                    etki = ((((puan77 + puan22) / 2) * 2) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik12 && tik18) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //kartlar yanlış evleri kontrol edip puan hesaplaması yapılabilir.
                    //birinci evin 1 ikinci evin 2 katsayılı olma durumu
                    etki = ((((puan88 + puan22) / 2) * 2) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik13 && tik15) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //yanlış eşleştirmede kartların farklı evlerden olma durumu
                    //birinci evin 2 ikinci evin 1 katsayılı olma durumu
                    etki = ((((puan33 + puan55) / 2) * 2) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik13 && tik16) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //yanlış eşleştirmede kartların farklı evlerden olma durumu
                    //birinci evin 1 ikinci evin 2 katsayılı olma durumu
                    etki = ((((puan33 + puan66) / 2) * 2) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik13 && tik17) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //yanlış eşleştirmede kartların farklı evlerden olma durumu
                    //birinci evin 1 ikinci evin 2 katsayılı olma durumu
                    etki = ((((puan33 + puan77) / 2) * 2) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik13 && tik18) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //kartlar yanlış evleri kontrol edip puan hesaplaması yapılabilir.
                    //birinci evin 1 ikinci evin 2 katsayılı olma durumu
                    etki = ((((puan33 + puan88) / 2) * 2) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik13 && tik21) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //evler aynı ise
                    //ev katsayısının 2 olma durumu
                    etki = (((puan11 + puan33) / 2.0)*4) * ((45.0 - kalansure) / 10.0);
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik13 && tik22) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //evler aynı ise
                    //ev katsayısının 2 olma durumu
                    etki = (((puan33 + puan22) / 2.0)*4) * ((45.0 - kalansure) / 10.0);
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik14 && tik15) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //yanlış eşleştirmede kartların farklı evlerden olma durumu
                    //birinci evin 2 ikinci evin 1 katsayılı olma durumu
                    etki = ((((puan44 + puan55) / 2) * 2) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik14 && tik16) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //yanlış eşleştirmede kartların farklı evlerden olma durumu
                    //birinci evin 1 ikinci evin 2 katsayılı olma durumu
                    etki = ((((puan44 + puan66) / 2) * 2) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik14 && tik17) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //yanlış eşleştirmede kartların farklı evlerden olma durumu
                    //birinci evin 1 ikinci evin 2 katsayılı olma durumu
                    etki = ((((puan44 + puan77) / 2) * 2) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik14 && tik18) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //kartlar yanlış evleri kontrol edip puan hesaplaması yapılabilir.
                    //birinci evin 1 ikinci evin 2 katsayılı olma durumu
                    etki = ((((puan44 + puan88) / 2) * 2) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik14 && tik21) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //evler aynı ise
                    //ev katsayısının 2 olma durumu
                    etki = (((puan11 + puan44) / 2.0)*4) * ((45.0 - kalansure) / 10.0);
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik14 && tik22) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //evler aynı ise
                    //ev katsayısının 2 olma durumu
                    etki = (((puan44 + puan22) / 2.0)*4) * ((45.0 - kalansure) / 10.0);
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik14 && tik23) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //evler aynı ise
                    //ev katsayısının 2 olma durumu
                    etki = ((puan44 + puan33) / 2.0) * ((45.0 - kalansure) / 10.0);
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik15 && tik16) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //kartlar yanlış evleri kontrol edip puan hesaplaması yapılabilir.
                    //ev katsayısının 2 olma durumu
                    etki = ((puan55 + puan66) / 1.0) * ((45.0 - kalansure) / 10.0);
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik15 && tik17) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //yanlış eşleştirmede kartların farklı evlerden olma durumu
                    //iki evin katsayısının 2 2 olma durumu
                    etki = ((((puan55 + puan77) / 2) * 1) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik15 && tik18) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //yanlış eşleştirmede kartların farklı evlerden olma durumu
                    //iki evin katsayısının 2 2 olma durumu
                    etki = ((((puan55 + puan88) / 2) * 1) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik15 && tik21) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //kartlar yanlış evleri kontrol edip puan hesaplaması yapılabilir.
                    //birinci evin 2 ikinci evin 1 katsayılı olma durumu
                    etki = ((((puan55 + puan11) / 2) * 2) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik15 && tik23) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //kartlar yanlış evleri kontrol edip puan hesaplaması yapılabilir.
                    //birinci evin 2 ikinci evin 1 katsayılı olma durumu
                    etki = ((((puan55 + puan33) / 2) * 2) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik15 && tik24) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //kartlar yanlış evleri kontrol edip puan hesaplaması yapılabilir.
                    //birinci evin 2 ikinci evin 1 katsayılı olma durumu
                    etki = ((((puan55 + puan44) / 2) * 2) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik15 && tik27) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //evler aynı ise
                    //ev katsayısının 2 olma durumu
                    etki = (((puan55 + puan77) / 1.0)*1) * ((45.0 - kalansure) / 10.0);
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik15 && tik28) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //evler aynı ise
                    //ev katsayısının 2 olma durumu
                    etki = (((puan55 + puan88) / 2.0)*1) * ((45.0 - kalansure) / 10.0);
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik16 && tik17) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //yanlış eşleştirmede kartların farklı evlerden olma durumu
                    //iki evin katsayısının 2 2 olma durumu
                    etki = ((((puan66 + puan77) / 2) * 1) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik16 && tik18) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //yanlış eşleştirmede kartların farklı evlerden olma durumu
                    //iki evin katsayısının 2 2 olma durumu
                    etki = ((((puan66 + puan88) / 2) * 1) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik16 && tik21) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //kartlar yanlış evleri kontrol edip puan hesaplaması yapılabilir.
                    //birinci evin 2 ikinci evin 1 katsayılı olma durumu
                    etki = ((((puan66 + puan11) / 2) * 2) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik16 && tik23) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //kartlar yanlış evleri kontrol edip puan hesaplaması yapılabilir.
                    //birinci evin 2 ikinci evin 1 katsayılı olma durumu
                    etki = ((((puan66 + puan33) / 2) * 2) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik16 && tik24) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //kartlar yanlış evleri kontrol edip puan hesaplaması yapılabilir.
                    //birinci evin 2 ikinci evin 1 katsayılı olma durumu
                    etki = ((((puan66 + puan44) / 2) * 2) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik16 && tik25) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //evler aynı ise
                    //ev katsayısının 2 olma durumu
                    etki = ((puan66 + puan55) / 1.0) * ((45.0 - kalansure) / 10.0);
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik16 && tik27) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //evler aynı ise
                    //ev katsayısının 2 olma durumu
                    etki = (((puan66 + puan77) / 1.0)*1) * ((45.0 - kalansure) / 10.0);
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik16 && tik28) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //evler aynı ise
                    //ev katsayısının 2 olma durumu
                    etki = (((puan66 + puan88) / 2.0)*1) * ((45.0 - kalansure) / 10.0);
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik17 && tik18) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //kartlar yanlış evleri kontrol edip puan hesaplaması yapılabilir.
                    //ev katsayısının 2 olma durumu
                    etki = ((puan77 + puan88) / 1.0) * ((45.0 - kalansure) / 10.0);
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik17 && tik23) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //kartlar yanlış evleri kontrol edip puan hesaplaması yapılabilir.
                    //birinci evin 2 ikinci evin 1 katsayılı olma durumu
                    etki = ((((puan77 + puan33) / 2) * 2) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik17 && tik24) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //kartlar yanlış evleri kontrol edip puan hesaplaması yapılabilir.
                    //birinci evin 2 ikinci evin 1 katsayılı olma durumu
                    etki = ((((puan77 + puan44) / 2) * 2) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik17 && tik25) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //evler aynı ise
                    //ev katsayısının 2 olma durumu
                    etki = (((puan77 + puan55) / 1.0)*1) * ((45.0 - kalansure) / 10.0);
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik17 && tik26) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //evler aynı ise
                    //ev katsayısının 2 olma durumu
                    etki = (((puan77 + puan66) / 2.0)*1) * ((45.0 - kalansure) / 10.0);
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik18 && tik23) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //kartlar yanlış evleri kontrol edip puan hesaplaması yapılabilir.
                    //birinci evin 2 ikinci evin 1 katsayılı olma durumu
                    etki = ((((puan88 + puan33) / 2) * 2) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik18 && tik24) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //kartlar yanlış evleri kontrol edip puan hesaplaması yapılabilir.
                    //birinci evin 2 ikinci evin 1 katsayılı olma durumu
                    etki = ((((puan88 + puan44) / 2) * 2) * ((45.0 - kalansure) / 10.0));
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik18 && tik25) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //evler aynı ise
                    //ev katsayısının 2 olma durumu
                    etki = (((puan88 + puan55) / 1.0)*1) * ((45.0 - kalansure) / 10.0);
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik18 && tik26) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //evler aynı ise
                    //ev katsayısının 2 olma durumu
                    etki = (((puan88 + puan66) / 2.0)*1) * ((45.0 - kalansure) / 10.0);
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
        ...
        if (tik18 && tik27) {
            ...
            handeler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    //evler aynı ise
                    //ev katsayısının 2 olma durumu
                    etki = ((puan88 + puan77) / 1.0) * ((45.0 - kalansure) / 10.0);
                    sonSkor = sonSkor - etki;
                    skor.setText("SKOR:" + sonSkor);
                }
            }, 800);
    ...
    public void baslaClicked(View view){
        ...
        new CountDownTimer(45000,1000){
            ...
            public void onFinish() {
                ...
                v27.setEnabled(false);
                v28.setEnabled(false);
                AlertDialog.Builder alert = new AlertDialog.Builder(TekLevel2Activity.this);
                ...
                alert.setNegativeButton("NO", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Intent intent = new Intent(TekLevel2Activity.this,TekLevel3Activity.class);
                        finish();
                        startActivity(intent);
                    }
                });
                            ...
                            for (QueryDocumentSnapshot document : task.getResult() ){
                                ...
                                if(i == e1k1){
                                    ...
                                    if(tik11){
                                        ...
                                        Toast.makeText(TekLevel2Activity.this,karakter1 +" "+puan1+" Gryffindor", Toast.LENGTH_SHORT).show();
                                    }
                                    if(tik21){
                                    ...
                                    if(tik12){
                                        ...
                                        Toast.makeText(TekLevel2Activity.this,karakter2 +" "+puan2+" Gryffindor", Toast.LENGTH_SHORT).show();
                                    }
                                    if(tik22){
                            ...
                            for (QueryDocumentSnapshot document : task.getResult() ){
                                ...
                                if(i == e2k1){
                                    ...
                                    if(tik13){
                                        ...
                                        Toast.makeText(TekLevel2Activity.this,karakter3 +" "+puan3+" Slytherin", Toast.LENGTH_SHORT).show();
                                    }
                                    if(tik23){
                                    ...
                                    if(tik14){
                                        ...
                                        Toast.makeText(TekLevel2Activity.this,karakter4 +" "+puan4+" Slytherin", Toast.LENGTH_SHORT).show();
                                    }
                                    if(tik24){
                            ...
                            for (QueryDocumentSnapshot document : task.getResult() ){
                                ...
                                if(i == e3k1){
                                    ...
                                    if(tik15){
                                        ...
                                        Toast.makeText(TekLevel2Activity.this,karakter5 +" "+puan5+" Hufflepuff", Toast.LENGTH_SHORT).show();
                                    }
                                    if(tik25){
                                    ...
                                    if(tik16){
                                        ...
                                        Toast.makeText(TekLevel2Activity.this,karakter6 +" "+puan6+" Hufflepuff", Toast.LENGTH_SHORT).show();
                                    }
                                    if(tik26){
                            ...
                            for (QueryDocumentSnapshot document : task.getResult() ){
                                ...
                                if(i == e4k1){
                                    ...
                                    if(tik17){
                                        ...
                                        Toast.makeText(TekLevel2Activity.this,karakter7 +" "+puan7+" Ravenclaw", Toast.LENGTH_SHORT).show();
                                    }
                                    if(tik27){
                                    ...
                                    if(tik18){
                                        ...
                                        Toast.makeText(TekLevel2Activity.this,karakter8 +" "+puan8+" Ravenclaw", Toast.LENGTH_SHORT).show();
                                    }
                                    if(tik28){
