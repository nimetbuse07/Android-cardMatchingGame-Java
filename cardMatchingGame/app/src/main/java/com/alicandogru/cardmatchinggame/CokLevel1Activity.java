...
public class CokLevel1Activity extends AppCompatActivity {
    long kalansure;
    double sonSkor=0.0,etki,sonSkor2=0.0;
    String puan1,puan2;
    double puan11,puan22;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cok_level1);
        switchSes = findViewById(R.id.switchCok1);

        oyunMuzik = MediaPlayer.create(CokLevel1Activity.this,R.raw.oyunmuzik);
        dogruMuzik = MediaPlayer.create(CokLevel1Activity.this,R.raw.dogrumuzik);
        oyunBitti = MediaPlayer.create(CokLevel1Activity.this,R.raw.oyunbitti);
        sureBitti = MediaPlayer.create(CokLevel1Activity.this,R.raw.surebittimuzik);
    ...
    public void baslaClicked(View view){
        ...
        new CountDownTimer(60000,1000){
            ...
            public void onFinish() {
                if(sonSkor>sonSkor2){
                    Toast.makeText(CokLevel1Activity.this, "Birinci Oyuncu Kazandı!", Toast.LENGTH_LONG).show();
                }if(sonSkor2>sonSkor){
                    Toast.makeText(CokLevel1Activity.this, "İkinci oyuncu kazandı!", Toast.LENGTH_LONG).show();
                }if(sonSkor == sonSkor2){
                    Toast.makeText(CokLevel1Activity.this, "Durum berabere!", Toast.LENGTH_LONG).show();
                }
                ...
                v21.setEnabled(false);
                v22.setEnabled(false);
                AlertDialog.Builder alert = new AlertDialog.Builder(CokLevel1Activity.this);
                ...
                alert.setNegativeButton("NO", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Intent intent = new Intent(CokLevel1Activity.this,CokLevel2Activity.class);
                        finish();
                        startActivity(intent);
                    }
                });
                        ...
                        if(task.isSuccessful()){
                            ...
                            for (QueryDocumentSnapshot document : task.getResult() ){
                                ...
                                if(i == k1){
                                    ...
                                    Toast.makeText(CokLevel1Activity.this,karakter1 +" "+puan1+" Gryffindor", Toast.LENGTH_SHORT).show();
                                    if(tik11){
                        ...
                        if(task.isSuccessful()){
                            ...
                            for (QueryDocumentSnapshot document : task.getResult() ){
                                ...
                                if(i == k2){
                                    ...
                                    Toast.makeText(CokLevel1Activity.this,karakter2+" "+puan2+" Slytherin", Toast.LENGTH_SHORT).show();
                                    if(tik12){
